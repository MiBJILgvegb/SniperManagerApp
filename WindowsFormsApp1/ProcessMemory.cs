...
namespace SniperManagerApp
{
    ...
    class ProcessMemory
    {
        ...
        public static byte[] GetBytes(long address,int size)
        {
        ...
        public static long GetDynamicAddress(long address, long[] offsets)
        {
            try
            {
                foreach (long offset in offsets) address = Read64BitInt(address) + offset;
                return address;
            }
            catch { }
            return 0;
