...
namespace SniperManagerApp
{
    class Pointers
    {
        ...
        public static readonly long TEKKEN7_DECODE_MAINCONST = unchecked ((long)0xEDCCFB96DCA40FBA);
        public static readonly long TEKKEN7_DECODE_SECONFCONST = unchecked((long)0x8000000000000000);
        public static readonly Dictionary<string, long> TEKKEN7_CONSTS =new Dictionary<string, long> { { "2F3B8", 0x4000000000000000 }, { "49178", 0x4020000000000000 } };
        public static readonly Dictionary<string, long> TEKKEN7_UCRTBASE_WCTYPE = new Dictionary<string, long> { { "4B08", 0x000FF00000000000 }, { "4B10", 0x0000080000000000 },{ "4A50", 0x43E0000000000000 }, { "4A58", unchecked((long)0x3C00000000000000) }, { "4A60", unchecked((long)0x8000000000000000) }, { "4A70", 0x7FF0000000000000 }, { "4A88", 0x3FF0000000000000 }, { "4A90", 0x0000000000000000 }, { "4A98", 0x7FFFFFFFFFFFFFFF }, { "4AA0", 0x00000000000003FF }, { "4B90", 0x000FFFFFFFFFFFFF }, { "4C80", unchecked((long)0xC08FF80000000000) },  };

        public static readonly Dictionary<uint, uint> CHARACTERINFO_MEMORY_KNOWEDDECUMALS = new Dictionary<uint, uint> { { 0, 0xCCA40FBD }, { 1, 0xF1481F7C }, { 2, 0x8B903EFF }, {3, 0x59207DDE }, { 4, 0xD840FBB9 }, { 5, 0xF481F758 }, {6, 0x8C03EEBB }, { 7, 0x7A07DD7A }, { 8, 0x9AFBAF5 }, { 10, 0xB83EEBB7 }, {11, 0x067DD776 }, { 12, 0x5EFBAED1 }, { 15, 0x83DD76F2 }, { 16, 0x40BAEDCD }, { 17,0xF875DB8C }, { 18, 0xA9EBB72F }, { 19, 0xDD76E6E }, { 20, 0x61AEDCC9 }, { 22, 0x39BB732B }, { 34, 0xAB903EDF }, { 37, 0xD0EDC225 }, { 43, 0x267DD756 }, { 44, 0x7EFBAEF1 }, { 46, 0xDCEEBB53 }, { 47, 0xA3DD76D2 },/*{ 48, 0x63198222 },*/ { 49, 0xD875DBAC }, { 50, 0x89EBB70F }, { 52, 0x41AEDCE9 },{ 58, 0x99B733C7 }, { 101, 0x9481F738 }, { 105, 0x041F75B4 }, { 106, 0xD83EEBD7 }, { 107, 0x667DD716 }, { 108, 0x3EFBAEB1 }, { 109, 0xA0F75DD0 }, { 110, 0x9CEEBB13 },{ 137, 0xE41F7554 }, { 144, 0xC0BAED4D }, { 145, 0x7875DBC0 }, { 197, 0x3481F798 }, { 198, 0x4C03EE7B }, { 200, 0x5A0FBA35 }, { 207,0x43DD7632 }, { 212, 0xA1AEDC09 }, { 213, 0x765DB948 }, {214, 0xF9BB73EB }, { 215, 0xE076E6AA }, { 216, 0xDEEDCC25 },{ 217, 0xBCDB9924 }, { 218, 0x79B73327 }, { 1850, 0x9EB734C7 }, { 2067 , 0x05D7666E }, { 2500, 0x1140F279 }, { 3917, 0xEB75BBFF }, { 4150, 0x09BB630B }, { 7000, 0x45EDD7A5 }, { 7250, 0xF5EBAB6F }, { 20014, 0x92EEF553 }, { 31642, 0x42B74867 }, { 34821, 0x7C817F58 }, { 34861, 0x68F7D590 }, { 49198, 0x1CEE7B53 }, { 56578, 0x5690E3FF }, { 58414, 0x38EE5F53 }, { 60929, 0x1F48F17C }, { 100000, 0x84E7FB42 }, { 200014, 0x92EEF553 }, { 200017, 0x967595AC }, { 500000, 0x23DF082E } };
